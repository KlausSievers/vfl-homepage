...
public class DocumentMetadata implements Serializable {
  ...
  private static final String PROP_ISSUE = "issue";
  ...
  public DocumentMetadata(String fileName, Date documentDate, String personName, Integer issue) {
    this(UUID.randomUUID().toString(), fileName, documentDate, personName, issue);
  }

  public DocumentMetadata(String uuid, String fileName, Date documentDate, String personName, Integer issue) {
    super();
    this.uuid = uuid;
  ...
  public DocumentMetadata(Properties properties) {
    this(properties.getProperty(PROP_UUID),
            ...
            properties.getProperty(PROP_ISSUE) == null ? null : Integer.parseInt(properties.getProperty(PROP_ISSUE)));
  ...
  public Properties createProperties() {
    ...
    props.setProperty(PROP_ISSUE, getIssue().toString());
    return props;
  }
